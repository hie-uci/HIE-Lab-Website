      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center group">
            <Image src="/images/logo/hie-logo.png" alt="HIE Lab logo" width={300} height={45} className="h-12 sm:h-18 w-auto group-hover:opacity-80 transition-opacity" unoptimized />
          </Link>
