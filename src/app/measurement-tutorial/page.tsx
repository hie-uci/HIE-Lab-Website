            ...
            <div className="glass-ios rounded-3xl p-6 sm:p-10 border border-white/40 dark:border-white/10">
              <div className="grid lg:grid-cols-2 gap-10 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                    Validating the performance of a wideband Voltage-Controlled Oscillator (VCO). This type of measurement is critical for characterizing the purity of the local oscillator (LO) signal used in RF transceivers.
                  </p>
