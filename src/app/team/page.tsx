...
const phdStudents: Member[] = [
  ...
  { name: 'Allen (Yilun) Huang', initials: 'AH', image: '/images/members/phd-allen-huang.png', focus: 'Analog, RF, and mm-wave circuits, AI-driven IC design', bio: 'received the B.S. degree in electrical engineering from Iowa State University, Ames, IA, USA, in 2022, and the M.S. degree in electrical engineering from the University of California, Los Angeles, CA, USA, in 2024. He is currently pursuing the Ph.D. degree in electrical engineering at the University of California, Irvine, CA, USA, with the High-Speed Integrated Electronics Laboratory. His research interests include analog, RF, and mm-wave circuit design, as well as machine learning/AI applications in circuit and radar system design.', gradientFrom: 'from-uci-gold', gradientTo: 'to-eecs-teal' },
...
const otherAlumni: Alumnus[] = [
  ...
  { name: 'Mengjie (Kaylee) Xie', initials: 'MX', image: '/images/members/alumni-kelly.jpg', detail: 'B.Sc.', now: 'Graduate Student, Stanford' },
