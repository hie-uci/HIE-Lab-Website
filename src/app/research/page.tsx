...
const projects: Project[] = [
  {
    ...
    description: [
      'Our lab develops phase-frequency-locked mm-wave radar architectures enabling wideband operation with precise frequency synthesis. These systems achieve unprecedented accuracy in target detection and characterization by leveraging novel PLL and frequency multiplication techniques.',
      'The radar platforms support multi-band operation across Ka-band and W-band frequencies, enabling simultaneous high-resolution range profiling and Doppler velocity estimation for a wide range of applications.',
    ],
    applications: [
    ...
    publications: ['JSSC 2025', 'ESSCIRC 2023', 'IEEE Comm. Magazine 2020', 'RFIC 2022', 'JSSC 2024'],
  ...
  },
  {
    ...
    description: [
      'This research thrust pushes signal generation beyond the fundamental frequency limits of transistors using innovative Volterra-Weiner theory-based design methodology. Our approach enables systematic synthesis of highly efficient harmonic power generation circuits.',
      'The techniques are technology-agnostic and have been demonstrated across MOSFET, BJT, HBT, and HEMT device technologies, opening pathways to practical THz sources in mainstream silicon processes.',
    ],
    applications: [
      'THz imaging systems',
      'Spectroscopy',
    ...
    publications: ['JSSC 2026', 'RWW 2026', 'APR 2020', 'TAP 2022', 'JSSC 2017', 'JSSC 2016', 'ISSCC 2015'],
  ...
  {
    id: 3,
    title: 'Efficient Wideband and Low Phase Noise Signal Generation',
    tagline: 'Novel oscillator structures for mm-wave and THz applications',
    description: [
      'We develop novel oscillator structures that overcome the fundamental trade-off between phase-noise degradation and limited tuning range at mm-wave and THz frequencies. Our architectures achieve state-of-the-art FoM by exploiting multi-mode resonance and distributed active topologies.',
      'These signal sources serve as critical building blocks for high-frequency communication transceivers, frequency-modulated radar sensors, and spectroscopic imaging systems.',
    ],
    applications: [
      'High-frequency communications',
    ...
    publications: ['JSSC 2025', 'TCAS2 2024', 'TCAS1 2023', 'SSCL 2018', 'TMTT 2019', 'MWTL 2025'],
  ...
  },
  {
    ...
    description: [
      'This research area bridges artificial intelligence with analog/RF integrated circuit design. We develop layout-aware ML pipelines for end-to-end circuit synthesis, including graph-based predictors that map from specifications directly to physical layouts.',
      'On the sensing side, we explore attention-guided beam control for MIMO radar arrays, enabling adaptive sensing that intelligently directs radar resources based on scene understanding and task requirements.',
    ],
    applications: [
      'Layout-aware circuit synthesis',
      'Graph-based spec-to-layout prediction',
      'Attention-guided radar beam control',
  ...
  },
  {
    ...
    description: [
      'We investigate next-generation device technologies including all-spin-logic smart detector cells that leverage spintronic phenomena for ultra-low-power signal processing and detection applications.',
      'Our work on Janus 2D materials (PtSSe) tunneling FETs demonstrates sub-60 mV/dec subthreshold switching, breaking the Boltzmann limit and enabling a new class of ultra-efficient transistors for future computing and sensing platforms.',
    ],
    applications: [
      'All-spin-logic smart detectors',
      'Janus 2D material (PtSSe) tunneling FETs',
      'Sub-60 mV/dec switching devices',
